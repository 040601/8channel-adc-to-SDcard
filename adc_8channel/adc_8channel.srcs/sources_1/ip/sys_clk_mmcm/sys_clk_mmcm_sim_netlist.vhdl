...
--               c:/Users/DELL/Desktop/CW4.team/adc_ethernet/adc_ethernet.srcs/sources_1/ip/sys_clk_mmcm/sys_clk_mmcm_sim_netlist.vhdl
-- Design      : sys_clk_mmcm
...
entity sys_clk_mmcm_sys_clk_mmcm_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of sys_clk_mmcm_sys_clk_mmcm_clk_wiz : entity is "sys_clk_mmcm_clk_wiz";
end sys_clk_mmcm_sys_clk_mmcm_clk_wiz;

architecture STRUCTURE of sys_clk_mmcm_sys_clk_mmcm_clk_wiz is
  signal clk_in1_sys_clk_mmcm : STD_LOGIC;
  signal clk_out1_sys_clk_mmcm : STD_LOGIC;
  signal clk_out2_sys_clk_mmcm : STD_LOGIC;
  signal clkfbout_buf_sys_clk_mmcm : STD_LOGIC;
  signal clkfbout_sys_clk_mmcm : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clkfbout_sys_clk_mmcm,
      O => clkfbout_buf_sys_clk_mmcm
    );
...
mmcme3_adv_inst: unisim.vcomponents.MMCME3_ADV
    generic map(
      ...
      CDDCREQ => '0',
      CLKFBIN => clkfbout_buf_sys_clk_mmcm,
...
entity sys_clk_mmcm is
  ...
  attribute NotValidForBitStream of sys_clk_mmcm : entity is true;
end sys_clk_mmcm;

architecture STRUCTURE of sys_clk_mmcm is
begin
inst: entity work.sys_clk_mmcm_sys_clk_mmcm_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
