...
HD_PWD='C:/Users/DELL/Desktop/CW4.team/adc_8channel/adc_8channel.runs/fifo3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo3.tcl
