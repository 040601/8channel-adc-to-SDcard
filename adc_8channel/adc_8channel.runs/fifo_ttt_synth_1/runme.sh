...
HD_PWD='C:/Users/DELL/Desktop/CW4.team/adc_8channel/adc_8channel.runs/fifo_ttt_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_ttt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_ttt.tcl
